...
// code for home screen navigation list
                ...
                <div style={styles.menuList} id='menu-list'>
                    ...
                    <ListGroup style={{borderRadius:'0'}}>
                        <ListGroup.Item style={{border:'0',padding: '0.2rem 0.6rem'}} className={this.props.activeItem==='NowPlaying'?'active':''}>
                            Cover Flow {this.props.activeItem==='NowPlaying'?<span style={{float:'right' ,fontWeight:'bold'}}>&gt;</span>:''}
                        </ListGroup.Item>
...
const styles = {
    ...
    imageContainer : {
        ...
        height : '100%',
        width : '50%',
        backgroundImage : 'url("https://cdn1.goibibo.com/voy_ing/t_g/cf8da9d2753a11e890190224510f5e5b.jpg")',
