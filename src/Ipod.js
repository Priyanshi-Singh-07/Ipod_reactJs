...
class Ipod extends React.Component{
   ...
   // code for wheel rotation 
    ...
    //code for changing the page on click
...
{// code for designing circular wheel
}
...
// Css style for ipod & button container

const styles = {
    ipodContainer : {
        height : '33rem',
        width : '20rem',
        backgroundImage: 'radial-gradient(#d9dcde,#adb1b5)',
        margin : '4rem auto',
        display : 'flex',
        flexDirection : 'row',
        flexWrap : 'wrap',
